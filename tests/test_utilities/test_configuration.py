import yaml
from loren.utilities.configuration import DEFAULT_CONFIG, init_configuration, get_configuration
...
def test_default_config():
    ...
    assert DEFAULT_CONFIG["file_handlers"]["*"] == "loren.parsers.text_parser.TextParser"
